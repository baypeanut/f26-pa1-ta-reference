...
REGISTER_GTEST(test_clear,            "clear",        1);
REGISTER_GTEST(test_hairlines_nodraw, "lines_nodraw", 1);
REGISTER_GTEST(test_rect_nodraw,      "rect_nodraw",  1);
